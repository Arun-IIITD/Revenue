...
data5 = data5[['Business Date','Individual Revenue']]
data5.columns = ['ds','y']
...
# print("Accuracy for 7 days for individual revnenue are",Accuracy_for_7_days)
# print("Avg Accuracy for 7 days for individual revenue are",round(mean(Accuracy_for_7_days)))
# print("Accuracy for 14 days for individual revnenue are",Accuracy_for_14_days)
# print("Avg Accuracy for 14 days for individual revnenue are",round(mean(Accuracy_for_14_days)))
# print("Accuracy for 21 days for individual revnenue are",Accuracy_for_21_days)
# print("Avg Accuracy for 21 days for individual revnenue are",round(mean(Accuracy_for_21_days)))
